    ...
    : QDialog(parent)
{
    ...
    pPrevBttn = new QPushButton("Prev", this);
    pNextBttn = new QPushButton("Next", this);
    pExitBttn = new QPushButton("Exit", this);
...
MainDlg::~MainDlg() {
	pPrevBttn->deleteLater();
	pNextBttn->deleteLater();
	pExitBttn->deleteLater();

	pStackedLayout->deleteLater();
	pNavigationBttnLayout->deleteLater();

	pHBoxDlg->deleteLater();
	pVBoxDlg->deleteLater();
	pBoxDlg->deleteLater();
	pGridDlg->deleteLater();

	pMainLayout->deleteLater();
