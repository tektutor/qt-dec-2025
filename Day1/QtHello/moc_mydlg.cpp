...
QT_MOC_LITERAL(1, 6, 20), // "onHelloButtonClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 19) // "onExitButtonClicked"

    },
    "MyDlg\0onHelloButtonClicked\0\0"
    "onExitButtonClicked"
};
...
void MyDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyDlg *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->onHelloButtonClicked(); break;
...
QT_INIT_METAOBJECT const QMetaObject MyDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_MyDlg.data,
    qt_meta_data_MyDlg,
    qt_static_metacall,
    nullptr,
    nullptr
